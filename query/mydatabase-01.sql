...
#부모테이블의 속성값을 삭제후 자식테이블의 속성값을 null로 하기 위한 외래키 생성 옵션을 이용하여 외래키를 재생성
...
insert into sample31(a,b,c) values(1,1,'값2');# column b가 중복 오류 발생 (unique값이여서 반드시 중복값이 존재되면 안됨)
...
insert into sample632(no,sub_no,name) values(1,3,'값3');
