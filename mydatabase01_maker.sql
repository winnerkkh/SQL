...
CREATE TABLE `maker` (
  `makercd` int(11) NOT NULL COMMENT '제조사코드',
  `name` varchar(45) DEFAULT NULL COMMENT '제조사명',
  PRIMARY KEY (`makercd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='제조사마스타';
...
INSERT INTO `maker` VALUES (5001,'농심'),(6001,'휘슬러'),(7001,'부루스타');
